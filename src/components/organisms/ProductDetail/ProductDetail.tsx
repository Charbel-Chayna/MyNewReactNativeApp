    ...
    <ScrollView contentContainerStyle={styles.container}>
            ...
            images.map((img, idx) => (
              ...
              >
                <View style={[styles.imageWrapper]}>
                  <Image source={{ uri: resolveUri(img.url) }} style={styles.image} />
                </View>
              </TouchableOpacity>
            ))
          ) : (
      ...
      <View style={styles.content}>
        ...
        <View style={styles.ownerContainer}>
          {/* Fix: mailto URL needs to be string in quotes */}
          <Button
        ...
        <View style={styles.buttonContainer}>
          ...
          <Button onPress={handleAddToCart} variant={ButtonVariant.PRIMARY}>
            Add to Cart
          </Button>
          {isOwner && onDelete && (
